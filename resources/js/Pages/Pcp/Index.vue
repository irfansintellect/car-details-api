                ...
                >
                    ...
                    <div class="container mx-auto pb-20 pt-20 px-4">
                        <div class="md:block lg:grid grid-cols-5 gap-10">
                                    ...
                                    <form>
                                        ...
                                        <div class="relative mb-10">
                                            ...
                                            >
                                                ...
                                                <div
                                                    class="mt-2 text-xl text-green-600"
                                                    v-else
                                                >
                                                    <div
                            ...
                            <div
                                class="relative col-span-3 mt-14 text-wrap flex flex-col justify-center text-white"
                            >
                                <h1
                                ...
                                <h1
                                    class="text-3xl md:text-6xl font-bold uppercase mb-3"
                                >
