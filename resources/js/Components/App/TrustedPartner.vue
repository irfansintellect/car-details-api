<template>
    <section class="py-4 sm:py-24">
        <div class="container mx-auto px-4 space-y-0">
            <div class="flex flex-wrap items-center ">
                ...
                <div class="py-4  w-full lg:w-6/12">
                    <div class="bg-white lg:-ml-12 lg:pl-12 lg:py-0 xl:py-12 md:border-0 lg:border pr-5">
                        <h4 class="pt-5 mb-5 capitalize font-bold text-3xl text-gray-900 xl:text-3xl">
                        ...
                        <p class="mb-5">
                            ...
                            That's where PCP Claims comes in – we're here to
                            guide you through the claims process with ease and
                            transparency.
                        </p>
